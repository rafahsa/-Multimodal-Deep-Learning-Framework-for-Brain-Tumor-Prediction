...
def main():
    ...
    parser.add_argument('--use-balanced-sampler', action='store_true',
                       help='Use WeightedRandomSampler (optional, LDAM+DRW is primary)')
    ...
    # Optional balanced sampler (if requested)
    train_sampler = None
    ...
    final_metrics = compute_metrics(final_val_labels, final_val_preds, final_val_probs)
    ...
    np.save(predictions_dir / 'val_preds.npy', final_val_preds)
