...
def main():
    ...
    for current_fold in folds_to_train:
        ...
        # Fix: Extract labels directly from samples to avoid incompatibility with ROI dataset __getitem__
        ...
        if args.use_class_weights:
            ...
            # Fix: Extract labels directly from samples to avoid incompatibility with ROI dataset __getitem__
            all_train_labels = [label for _, label, _ in train_dataset.samples]
